 ...
 */
public class ProfileImageDetailsActivity extends AppCompatActivity {
    private static final String TAG = ProfileImageDetailsActivity.class.getName();
...
//    private FloatingActionButton mBtnDownload;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.t_activity_profile_image_details);
