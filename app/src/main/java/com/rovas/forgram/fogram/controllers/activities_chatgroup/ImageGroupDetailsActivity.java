 ...
 */
public class ImageGroupDetailsActivity extends AppCompatActivity {
    private static final String TAG = ImageGroupDetailsActivity.class.getName();
...
//    private FloatingActionButton mBtnDownload;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        message = (MessageGroup) getIntent().getExtras().getSerializable(ChatUI.BUNDLE_MESSAGE);
