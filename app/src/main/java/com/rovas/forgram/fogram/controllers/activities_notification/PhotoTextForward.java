 ...
 */
public class PhotoTextForward extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.single_list_item_image_text);
        //Views
        ...
        //SharedPreferences
        SharedPreferences prefs_c_p = PreferenceManager.getDefaultSharedPreferences(PhotoTextForward.this);
                ...
                if(task.isSuccessful()) {
                    if (task.getResult().exists()) {
                        ...
                        try {
                            ...
                            String lastSeenTime = GetTimeAgo.getTimeAgo(millisecond, PhotoTextForward.this);
                            blogDate.setText(lastSeenTime);
                        } catch (Exception e) {

                            Toast.makeText(PhotoTextForward.this, "Exception : " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                                        ...
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            fStore.collection("users/" + Ownder_id + "/Notifications").add(notificatinMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                                                ...
                                                                public void onComplete(@NonNull Task<DocumentReference> task) {
                                                                    if (!task.isSuccessful()) {
                                                                        Toast.makeText(PhotoTextForward.this, "Error Send Notification : " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        ...
                        fStore.collection("Posts/" + forward + "/Likes").document(currentUserId).addSnapshotListener(new EventListener<DocumentSnapshot>() {
                            ...
                            public void onEvent(DocumentSnapshot documentSnapshot, FirebaseFirestoreException e) {
                                ...
                                if(documentSnapshot.exists()){
                                    ...
                                    blogLikeBtn.setImageDrawable(ContextCompat.getDrawable(PhotoTextForward.this, R.mipmap.action_like_accent));

                                } else {

                                    blogLikeBtn.setImageDrawable(ContextCompat.getDrawable(PhotoTextForward.this ,R.drawable.ic_like));
                        ...
                        blogCommentBtn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent commentIntent = new Intent(PhotoTextForward.this, CommentsActivity.class);
                        ...
                        blogUserImage.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent commentIntent = new Intent(PhotoTextForward.this, vProfileActivity.class);
                        ...
                        more_btn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                android.support.v7.widget.PopupMenu popupMenu = new android.support.v7.widget.PopupMenu(PhotoTextForward.this, more_btn);
                                    ...
                                    public boolean onMenuItemClick(MenuItem item) {
                                        ...
                                        switch (item.getItemId()) {
                                            case R.id.mnu_item_save:
                                                Toast.makeText(PhotoTextForward.this, "Saved", Toast.LENGTH_LONG).show();
                                                break;
                                                ...
                                                if (Ownder_id.equals(currentUserId))
                                                {
                                                    fStore.collection("Posts").document(forward).delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        ...
                                                        public void onComplete(@NonNull Task<Void> task) {
                                                            ...
                                                            Intent Intent = new Intent(PhotoTextForward.this, HomeActivity.class);
                                                            startActivity(Intent);
                                                            finish();//Don't Return AnyMore TO the last page
                                                            Toast.makeText(PhotoTextForward.this, "Deleted", Toast.LENGTH_LONG).show();
    ...
    public void setUserData(String name, String image){
        ...
        if(image != null) {
            Glide.with(PhotoTextForward.this).load(image).into(blogUserImage);
        }
