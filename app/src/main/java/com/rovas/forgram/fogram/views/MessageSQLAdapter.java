...
import com.rovas.forgram.fogram.controllers.activities_chat.ImageDetailsActivity;
...
public class MessageSQLAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    //
    public MessageSQLAdapter(List<Message> mMessageList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case sender_txt://0
                ...
                break;
            case received_txt://1
                view = inflater.inflate(R.layout.message_single_layout_chat, parent, false);
            ...
            case sender_img://2
                ...
                break;
            case received_img://3
                view = inflater.inflate(R.layout.message_single_layout_img_chat, parent, false);
            ...
            case received_voice://7
                view = inflater.inflate(R.layout.message_single_layout_record_chat, parent, false);
    ...
    public void onBindViewHolder_Sender_IMG(final Sender_IMG_ViewHolder viewHolder, int i) {
        ...
        viewHolder.Main_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(ChatUI.BUNDLE_MESSAGE, (Serializable) c);
