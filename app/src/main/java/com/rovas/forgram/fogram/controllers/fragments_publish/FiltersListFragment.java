...
import com.rovas.forgram.fogram.Utils.Filters.SpacesItemDecoration;
import com.rovas.forgram.fogram.Utils.Filters.ThumbnailsAdapter;
    ...
    public void prepareThumbnail(final Bitmap bitmap) {
        Runnable r = new Runnable() {
            public void run() {
                ...
                if (bitmap == null) {
                    thumbImage = BitmapUtils.getBitmapFromAssets(getActivity(), ImageEActivity.IMAGE_NAME, 100, 100);
                } else {
