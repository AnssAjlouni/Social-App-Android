 ...
 */
public class SingleEditorActivity extends AppCompatActivity implements FiltersListFragment.FiltersListFragmentListener, EditImageFragment.EditImageFragmentListener ,View.OnClickListener  {
    ...
    private ChatSQLActivity chatSQLActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // ================ Pix Library ================
        Pix.start(SingleEditorActivity.this, SELECT_GALLERY_IMAGE, 1);
        // ================ Firebase ================
        user_id = FirebaseAuth.getInstance().getCurrentUser().getUid();
        chatSQLActivity = new ChatSQLActivity();
    ...
    private void setupViewPager(ViewPager viewPager) {
        SingleEditorActivity.ViewPagerAdapter adapter = new SingleEditorActivity.ViewPagerAdapter(getSupportFragmentManager());
...
*/
        ...
        /*
        try {
            compressedImageFile = new Compressor(SingleEditorActivity.this)//Compressor Library
                    .setMaxWidth(300)
                    .setMaxHeight(200)
                    .setQuality(1)
        ...
        // Create Upload Task
        chatSQLActivity.AddImage( filePath, thumb_data , imageRef , user_id , to_user_id , timestamp.getTime());
        finish();
        */
    }
    @Override
