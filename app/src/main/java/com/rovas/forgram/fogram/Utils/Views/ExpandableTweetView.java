...
public class ExpandableTweetView extends LinearLayout implements View.OnClickListener {

    private static final String TAG = ExpandableTweetView.class.getSimpleName();
    ...
    public ExpandableTweetView(Context context) {
        this(context, null);
    }

    public ExpandableTweetView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public ExpandableTweetView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void findViews() {
        mTv = (TextView) findViewById(R.id.blog_Tweet);
