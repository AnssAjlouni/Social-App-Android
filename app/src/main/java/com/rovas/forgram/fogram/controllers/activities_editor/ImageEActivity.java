 ...
 */
public class ImageEActivity extends AppCompatActivity implements FiltersListFragment.FiltersListFragmentListener, EditImageFragment.EditImageFragmentListener {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ImageEActivity.ViewPagerAdapter adapter = new ImageEActivity.ViewPagerAdapter(getSupportFragmentManager());
    ...
    private void loadImage() {
        ...
        */
        ...
        //UniversalImageLoader.setImage(imgUrl, imagePreview, null, mAppend);
        ...
        nextScreen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ImageEActivity.this, NextActivity.class);
