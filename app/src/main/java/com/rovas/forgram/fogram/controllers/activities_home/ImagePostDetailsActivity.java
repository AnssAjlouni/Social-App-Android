 ...
 */
public class ImagePostDetailsActivity extends AppCompatActivity {
    private static final String TAG = ImagePostDetailsActivity.class.getName();

    private BlogPost post_Img;
...
//    private FloatingActionButton mBtnDownload;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        post_Img = (BlogPost) getIntent().getExtras().getSerializable(PostUI.POST_IMAGE_BUNDLE);

        // ### begin toolbar
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        setTitle(post_Img.getUsername());
        // ### end toolbar
        ...
        // ### begin image
        String imgUrl = post_Img.getImage_url();
        setImage(imgUrl);
        // ### end image

        // ### begin title
        String title = post_Img.getUsername();
        ...
        // ### begin sender
        String sender = post_Img.getText_post();
        ...
        try {
            long timestamp = post_Img.getTime_stamp();
